                            ...
                            if (timeDiff > 360000) {
                                ...
                                if (timeDiff > 600000) {
                                    ...
                                    if (timeDiff > 1200000) {
                                        ...
                                        if (timeDiff > 1800000) {
                                            Utils.drawStringCentered(EnumChatFormatting.RED + "" + EnumChatFormatting.BOLD + "You don't know whats gonna happen to you", Minecraft.getMinecraft().fontRendererObj,

...
public class NEUEventListener {
    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        Keyboard.enableRepeatEvents(Minecraft.getMinecraft().currentScreen != null && (Minecraft.getMinecraft().currentScreen instanceof GuiChat || Minecraft.getMinecraft().currentScreen instanceof GuiEditSign || Minecraft.getMinecraft().currentScreen instanceof GuiScreenBook));
                ...
                if (!joinedSB) {
                    ...
                    if (!NotEnoughUpdates.INSTANCE.config.hidden.loadedModBefore) {
                        ...
                        if (Constants.MISC == null || !Constants.MISC.has("featureslist")) {
                            ...
                            Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(""));
                            Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.BLUE + "It seems this is your first time using NotEnoughUpdates."));
                            ChatComponentText clickTextFeatures = new ChatComponentText(EnumChatFormatting.YELLOW + "Click this message if you would like to view a list of NotEnoughUpdate's Features.");
                        ...
                        Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(""));
                        ChatComponentText clickTextHelp = new ChatComponentText(EnumChatFormatting.YELLOW + "Click this message if you would like to view a list of NotEnoughUpdate's commands.");

...
- Fork the NEU repository using the fork button on top right of the page.
- Clone the forked repository using `git clone https://github.com/<YourUserName>/<ForkedRepoName>`.
